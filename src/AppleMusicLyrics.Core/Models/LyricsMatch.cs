...
public enum TitleEvidenceStrength
{
    None,
    Weak,
    Strong,
...
/// </summary>
public sealed record LyricsMatch(
    LyricsDocument Document,
    int Score,
    double DurationDelta,
    bool HasContentMatch = false,
    TitleEvidenceStrength TitleEvidence = TitleEvidenceStrength.None)
{
    public TitleEvidenceStrength EffectiveTitleEvidence => TitleEvidence != TitleEvidenceStrength.None
        ? TitleEvidence
        : HasContentMatch
            ? TitleEvidenceStrength.Strong
            : TitleEvidenceStrength.None;
}
